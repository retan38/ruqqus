...
INSERT INTO boards(id, name, is_banned, created_utc, description, description_html, creator_id, color) VALUES(1, 'general', 'false', 1592984412, 'board description', '<p>general description</p>+', 1, '805ad5');